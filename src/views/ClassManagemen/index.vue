  ...
  <div class="home-main">
    ...
    <el-table ref="filterTable" :data="tableData" style="width: 100%;text-align:center;">
      ...
      <el-table-column prop="tag" label="操作">
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-edit" @click="edit(scope.row)" size="small">关联</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="block">
  ...
  methods: {
    ...
    datalist() {
      user({ page: this.page }).then(res => {
        ...
        this.total = parseInt(res.total) * parseInt(res.per_page);
        console.log("用户数据");
        console.log(res);
      });
    },
